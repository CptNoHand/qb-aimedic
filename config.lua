...
Config.treatCost         = 1000                -- The treat costs (change if needed)
Config.spawnRadius       = 100                 -- Not active yet

Config.Ped = {
    ['ambulance'] = {
        company          = "Erste Hilfe",      -- The Company name used for sending mails
        name             = "Doktor Strange",    -- The name of the docter using for sending mail
